jQuery(function() {
  ...
  jQuery(".youtube").colorbox({iframe:true, innerWidth:640, innerHeight:390});
	...
	jQuery(".bottom-footer > div h3.heading").click(function () {
...
jQuery(document).ready(function() {
	jQuery(".pro-head-over> h3.mobi-drop-icon").click(function () {
		if (jQuery(this).hasClass('closed')) {
			jQuery(this).removeClass('closed').addClass('open');
			jQuery(this).next().toggle().removeClass('show-sub').addClass('hide-sub');
		} else {
...
jQuery(document).ready(function() {
	jQuery(".pro-head-over-information> h3.mobi-drop-icon").click(function () {
		if (jQuery(this).hasClass('closed')) {
			jQuery(this).removeClass('closed').addClass('open');
			jQuery(this).next().toggle().removeClass('show-sub').addClass('hide-sub');
		} else {
...
jQuery(document).ready(function() {
	jQuery(".Product-qa-main> h3.mobi-drop-icon").click(function () {
		if (jQuery(this).hasClass('closed')) {
			jQuery(this).removeClass('closed').addClass('open');
			jQuery(this).next().toggle().removeClass('show-sub').addClass('hide-sub');
		} else {
...
jQuery(document).ready(function() {
	jQuery(".product-view #customer-reviews.box-collateral > h3.mobi-drop-icon").click(function () {
		if (jQuery(this).hasClass('active')) {
			jQuery(this).removeClass('active').addClass('open');
			jQuery(this).next().toggle().removeClass('show-sub').addClass('hide-sub');
		} else {
...
jQuery(document).ready(function() {
	function close_accordion_section(accordingval) {
		jQuery('.'+accordingval).removeClass('active');
		jQuery('#'+accordingval).slideUp(300).removeClass('open');
	}
	...
	jQuery('#locator .results a.title').click(function(e) {
		...
		if(jQuery(e.target).is('.active')) {
			close_accordion_section(jQuery(this).data( "title"));
		}else {
			close_accordion_section(jQuery(this).data( "title"));
			jQuery(this).addClass('active');
