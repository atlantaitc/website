...
GasHelper.prototype._sanitizeString = function(str, strict_opt) {
    str = str.toLowerCase()
        ...
        .replace(/\ +$/, '')
        .replace(/\s+/g, '_')
        .replace(/[ÃƒÂ¡Ãƒ ÃƒÂ¢ÃƒÂ£ÃƒÂ¥ÃƒÂ¤ÃƒÂ¦Ã‚Âª]/g, 'a')
        .replace(/[ÃƒÂ©ÃƒÂ¨ÃƒÂªÃƒÂ«Ãâ€žÃ¢â€šÂ¬]/g, 'e')
        .replace(/[ÃƒÂ­ÃƒÂ¬ÃƒÂ®ÃƒÂ¯]/g, 'i')
        .replace(/[ÃƒÂ³ÃƒÂ²ÃƒÂ´ÃƒÂµÃƒÂ¶ÃƒÂ¸Ã‚Âº]/g, 'o')
        .replace(/[ÃƒÂºÃƒÂ¹ÃƒÂ»ÃƒÂ¼]/g, 'u')
        .replace(/[ÃƒÂ§Ã‚Â¢Ã‚Â©]/g, 'c');
