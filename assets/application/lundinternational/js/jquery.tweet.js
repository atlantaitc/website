(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["lundinter"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      loading_text: "",                     // [string]   optional loading text, displayed while tweets load
    ...
    function build_url() {
      //return base +"includes/cache/twitter.json";
      ...
      if (s.loading_text) $(widget).append(loading);
       $.getJSON(build_url(), function(data){
        ...
        $.each(tweets, function(i,item){
          ...
          var real_name = item.from_user || item.user.name;
          var profile_image_url = item.profile_image_url || item.user.profile_image_url;
          var join_template = '<span class="tweet_join"><a target="_blank" href="http://twitter.com/'+from_user+'">'+real_name+'</a> - </span>';
          ...
          list.append('<li><div class="tweet>"'+ text +' - '+ date+'</div></li>');
